...
contract MIRROR is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0x62d561747358F0259273A77F91588228a949f5a5);
    ...
    constructor () BEP20Detailed("MIRROR", "MIRROR", 18) {
      _owner = msg.sender ;
    ...
    {
        require(_numTokensSellToFee >= 2000 * 10**18 && _numTokensSellToFee <= 200000 * 10**18, "Threshold must be set within 2,000 to 200,000 tokens");
